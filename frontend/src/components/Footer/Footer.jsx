      ...
      <div className="container px-8 sm:px-16 py-4 mx-auto">
          ...
          <div className="w-full -mx-6 lg:w-2/5">
            <div className="px-6">
              ...
              <p className="max-w-md mt-2 text-gray-500 dark:text-gray-400">
                The trading platform for all.
              </p>

              <div className="flex mt-4 -mx-2">
                <a
                  href="https://github.com/Nathan-dot/stocks-trading-app"
          ...
          <div className="mt-6 lg:mt-0 lg:flex-1">
            <div className="grid grid-cols-2 gap-6 sm:grid-cols-4">
              ...
              <div>
                ...
                <a
                  href="https://silly-shirley-309cb3.netlify.app/"
                  className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline"
                  target="_blank"
                  rel="noopener noreferrer"
                >
        ...
        <div>
          <p className="text-center text-gray-800 dark:text-white">
            © Mock Stocks {new Date().getFullYear()}
          </p>
        </div>
      </div>
    </footer>
